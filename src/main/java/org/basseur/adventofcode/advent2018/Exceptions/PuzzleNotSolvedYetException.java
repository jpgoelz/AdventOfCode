...
@ResponseStatus(value = HttpStatus.SERVICE_UNAVAILABLE, reason = "This puzzle has not been solved yet. Please contact your local nerd to implement a solution for that first.")
